<?php declare(strict_types=1);
    ...
    use App\GraphQL\Resolvers\Note;
    ...
    return [
       ...
       |--------------------------------------------------------------------------
       |
       | This configuration allows you to define the resolvers for your queries and mutations.
       |
       */

        'resolvers' => [
            'Query' => [
                'notes' => Note::class . '@resolveNotes',
                'note' => Note::class . '@resolveNote',
            ],
            'Mutation' => [
                'createNote' => Note::class . '@resolveCreateNote',
                'updateNote' => Note::class . '@resolveUpdateNote',
                'deleteNote' => Note::class . '@resolveDeleteNote',
            ],
        ],
    ];
